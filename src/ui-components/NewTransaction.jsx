    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new Accounts(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "NewTransaction")}
      {...rest}
    >
      <TextField
        label="Name"
        descriptiveText="Name of the account. Not case-sensitive"
        isRequired={true}
        isReadOnly={false}
        placeholder="Acme Bank Personal Loan"
        value={Name}
        onChange={(e) => {
          let { value } = e.target;
          if (onChange) {
