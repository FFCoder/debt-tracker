...
export default function TransactionsUpdateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setAdjustment(cleanValues.Adjustment);
    setAmount(cleanValues.Amount);
    setErrors({});
  };
  const [transactionsRecord, setTransactionsRecord] =
    React.useState(transactions);
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? await DataStore.query(Transactions, idProp)
        : transactions;
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(
            Transactions.copyOf(transactionsRecord, (updated) => {
    ...
    >
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || transactions)}
